            ...
            <Card className="max-w-4xl mx-auto p-1 shadow-lg border-gray-700 bg-black transition-colors duration-300">
              <div className="relative">
                <Textarea
                  ...
                  className="w-full min-h-[100px] border-0 focus-visible:ring-0 text-lg p-6 resize-none bg-black text-white placeholder:text-gray-500 transition-colors duration-300"
